...
export const routes: Routes = [
  ...
  { path: 'verify-email', loadComponent: () => import('./features/auth/components/email-verification/email-verification.component').then(m => m.EmailVerificationComponent) },
  { path: 'password-reset-request', loadComponent: () => import('./features/auth/components/password-reset-request/password-reset-request.component').then(m => m.PasswordResetRequestComponent) },
  { path: 'password-reset', loadComponent: () => import('./features/auth/components/password-reset/password-reset.component').then(m => m.PasswordResetComponent) },
